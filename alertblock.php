 ...
 * Description:       Plugin block to create custom alert messages.
...
function create_block_alertblock_block_init() {
	register_block_type( __DIR__ . '/build' );
}
add_action( 'init', 'create_block_alertblock_block_init' );
